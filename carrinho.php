  ...
  ?>
    ...
    $valorTotal = 0;
        ...
        foreach ($_SESSION['carrinho'] as $index => $produtoNoCarrinho) {
            echo "<tr>";
            echo "<td>";
            echo "<strong>ID:</strong> " . $produtoNoCarrinho['id'] . "<br>";
            echo "<strong>Produto:</strong> " . $produtoNoCarrinho['produto'] . "<br>";
            echo "<strong>Marca:</strong> " . $produtoNoCarrinho['marca'] . "<br>";
            echo "<strong>Caracteristicas:</strong> " . $produtoNoCarrinho['caracteristicas'] . "<br>";
            echo "<strong>Preço: R$</strong> " . $produtoNoCarrinho['valordevenda'] . "</td>";
            // Valor padrão do select
    $valorPadraoSelect = 1;
