...
<fieldset>
<form id="dataRelatorio" method="POST" action="consultaimagem.php">
...
$sql = "SELECT * FROM novos WHERE produto = '$nome' or id = '$nome' ORDER BY id DESC";
...
$result = $conexao->query($sql);
      ...
      while($user_data = mysqli_fetch_assoc($result))
      {
        ...
        echo "<td>" .$user_data['hora']. "</td>";
          ...
          echo "<td> 
          <a class='btn btn-sm btn-primary' href='editimagem.php?id=$user_data[id]' title='Editar'>
