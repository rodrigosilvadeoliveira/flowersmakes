...
$sql = "SELECT * FROM novos WHERE data_hora BETWEEN '$inicio' AND '$fim'";
...
$sheet->setCellValue('J1', 'Data_Hora');
...
if ($result) {
    ...
    $sheet->setCellValue('J' . $row, $row_data['data_hora']);
    $row++;
}
}else {
...
header('Content-Disposition: attachment; filename="estoque_por_periodo.xlsx"');
